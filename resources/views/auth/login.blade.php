		...
		<div class="auth-side-form">
             <form method="POST" action="{{ route('phone') }}">
                ...
                <div class=" auth-content">
                    ...
                    <div class="form-group mb-4">
                        <label class="floating-label" for="Password">Telephone</label>
                        <input type="password" class="form-control @error('telephone') is-invalid @enderror" id="telephone" name="telephone" placeholder="" value="{{ old('telephone') }}">
                        @error('telephone')
