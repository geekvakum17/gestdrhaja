          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="text-center">
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModal-2">Ajouter un Guichet<i class="mdi mdi-plus ml-1"></i></button>
              </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel-2">Ajouter un guichet</h5>
            ...
            <form method="POST" action="{{ route('guichet.store') }}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="form-group">
                            <label class="floating-label" for="Name">Agence Regionale</label>
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-light" data-dismiss="modal">Annuller</button>
        </div>
    </form>
      </div>
    </div>
